...
| Document | What is in it |
|---|---|
| [editions.md](editions.md) | Which edition to take, on one page: how many files each is, its size once unpacked, whether Python or conda is needed, and whether the AI models are inside. |
...
| 文書 | 何が書いてあるか |
|---|---|
| [editions.md](editions.md) | どの形を選ぶか、1 枚で。何本あるか・展開後の大きさ・Python や conda が要るか・AIモデルが中に入っているか。 |
