...
This page is for the **package edition** (`cynovela-chewie-package-1.0.7.tar.gz`).
...
```
cynovela-chewie-package-1.0.7.tar.gz
cynovela-chewie-models-1.0.7.tar.gz.part00
cynovela-chewie-models-1.0.7.tar.gz.part01
cynovela-chewie-models-1.0.7.tar.gz.part02
SHA256SUMS
```
...
```
cat cynovela-chewie-models-1.0.7.tar.gz.part* > cynovela-chewie-models-1.0.7.tar.gz
```
...
```
cynovela-chewie-models-1.0.7.tar.gz: OK
cynovela-chewie-package-1.0.7.tar.gz: OK
```
...
```
tar -xzf cynovela-chewie-package-1.0.7.tar.gz
```
...
```
tar -xzf ../cynovela-chewie-models-1.0.7.tar.gz
```
...
このページは**パッケージ版**（`cynovela-chewie-package-1.0.7.tar.gz`）向けです。
