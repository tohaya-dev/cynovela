...
|---|---|---|---|---|
| File | **In preparation** — not part of this release | `cynovela-chewie-package-1.1.2.tar.gz` | not a download — the source is this repository | `cynovela-chewie-models-1.1.2.tar.gz.part00`–`part02` |
...
|---|---|---|---|---|
| ファイル | **準備中です。** この版には入っていません | `cynovela-chewie-package-1.1.2.tar.gz` | ダウンロードではありません。ソースはこのリポジトリです | `cynovela-chewie-models-1.1.2.tar.gz.part00`〜`part02` |
| 本数 | — | 1本 | — | 3本（つなぐ） |
